        ...
        ZStack {
            ...
            TabView(selection: $page) {
                OnboardingDemoPage(
                    ...
                    .tag(0)
                OnboardingSharePage(
                    demo: demo, isActive: page == 1, screenSize: screenSize)
                    .tag(1)
                OnboardingMessagesPage(
                    demo: demo, isActive: page == 2, screenSize: screenSize)
                    .tag(2)
                OnboardingFinalPage(model: model, safeArea: safeArea, doc: $doc)
                    .tag(3)
            }
