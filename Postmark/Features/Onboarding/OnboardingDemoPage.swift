...
/// stamp and takes the postmark — the real product animations on bundled
...
struct OnboardingDemoPage: View {
    ...
    @State private var showsPostmark = false
